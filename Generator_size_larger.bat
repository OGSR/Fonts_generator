...
rem start "FontGen" /min "%MYDATA%\FontGen" /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,11,15,15,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_11_%LANG%.fd"
rem start "FontGen" /min "%MYDATA%\FontGen" /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,13,16,16,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_13_%LANG%.fd"
rem start "FontGen" /min "%MYDATA%\FontGen" /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,15,19,19,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_15_%LANG%.fd"
"%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,16,20,20,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_11_%LANG%.fd"
start "FontGen" /min "%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,17,22,22,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_13_%LANG%.fd"
start "FontGen" /min "%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,18,23,23,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_15_%LANG%.fd"
start "FontGen" /min "%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,20,25,25,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_16_%LANG%.fd"
"%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,21,26,26,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_17_%LANG%.fd"
start "FontGen" /min "%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,23,29,29,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_18_%LANG%.fd"
"%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,25,31,31,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_20_%LANG%.fd"
"%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,26,32,32,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_21_%LANG%.fd"
start "FontGen" /min "%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,28,33,33,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_23_%LANG%.fd"
"%MYDATA%\FontGen" /x2 /argb:%FONTGEN_ARGB% /add:"%MYTEMP%\Char.txt",%FontName%,0,30,35,35,0,0,0,0,0,0 /bpp:%FONTGEN_BPP% /save:"%MYTEMP%\ui_font_25_%LANG%.fd"
