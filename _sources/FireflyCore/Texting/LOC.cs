...
// Description: Graphic text file class
// Version:     2009.10.31.
// Copyright(C) F.R.C.
// 
// ==========================================================================
...
{
    /// <summary>Graphic text file class</summary>
    public class LOC
    {
        ...
        /// <summary>Font library. Do not modify the font. Consider creating a new instance of LOC so that the internal state of LOC is normal. </summary>
        ...
        /// <summary>Glyph graph. Instead of modifying the glyph map, consider creating a new instance of LOC so that the internal state of LOC is normal. </summary>
        ...
        /// <summary>Character code point-glyph number mapping. Do not modify, consider creating a new instance of LOC so that the internal state of LOC is normal. </summary>
        ...
        /// <summary>Text. Do not modify this text, but consider creating a new instance of LOC so that the internal state of LOC is normal. </summary>
        ...
        /// <summary>Reloaded. Create a new graphic text class. </summary>
        ...
        /// <summary>Generate graphic text file. Generate 32-bit BMP. If other BMPs are needed, they can be generated by imitating this function. All font character sizes must be no larger than the maximum character width and height. </summary>
        ...
        /// <summary>Reloaded. Reads a graphic text file from a stream. </summary>
        public LOC(ZeroPositionStreamPasser sp)
        {
            ...
            try
            {
                ...
                int TextInfoDBLength = s.ReadInt32(); // Being not
        ...
        /// <summary>Write graphic text files to the stream. </summary>
    ...
    public class GlyphMap
    {
        ...
        /// <summary>The maximum width of the glyph. </summary>
       ...
       /// <summary>The height of the glyph. </summary>
        ...
        /// <summary>Glyph width table. </summary>
        ...
        /// <summary>The number of glyphs per line. </summary>
       ...
       /// <summary>Image height. </summary>
        ...
        /// <summary>Reloaded. Construct glyph images. A default width table is automatically created and all values ​​are initialized to Glyph Width. If an empty Bmp is passed in, a 32-bit Bmp of appropriate size will be automatically created according to Glyph Count. </summary>
        ...
        /// <summary>Reloaded. Construct glyph images. If an empty Bmp is passed in, a 32-bit Bmp of appropriate size will be automatically created according to Glyph Count. </summary>
        ...
        /// <summary>Get the square position of the glyph. </summary>
    ...
    /// <summary>Graphic text class</summary>
    public class GlyphText
    {

        protected FontLib FontLibValue;
        /// <summary>Font library. </summary>
        public FontLib FontLib
        {
            get
            {
        ...
        protected int GlyphWidthValue;
        /// <summary>The default width (maximum width) of the glyph. </summary>
        public int GlyphWidth
        {
            get
            {
        ...
        /// <summary>Reloaded. Create an instance from a font library, default glyph size, and text code points. </summary>
        ...
        /// <summary>Reloaded. Creates an instance from default glyph size and text. </summary>
        ...
        /// <summary>Reloaded. Create an instance from a graphic text file. If the graphics text file does not contain Font Lib or Glyph Map, an exception will be thrown. </summary>
        public GlyphText(LOC LOC) : this(LOC.FontLib, LOC.GlyphMap.GlyphWidth, LOC.GlyphMap.GlyphHeight, LOC.Text)
        {
        }

        /// <summary>Add glyphs to characters. </summary>
        public delegate int[,] DrawGlyph(string c);

        /// <summary>Reloaded. Adds glyphs to all glyphless, non-controlled Unicode characters using the specified font. </summary>
        ...
        /// <summary>Generate graphic text file. </summary>
        public virtual LOC GenerateLOC()
        {
            return LOC.GenerateLOC(FontLibValue, TextValue);
        }

       /// <summary>Draw the text represented by Char Info. </summary>
                ...
                foreach (var GlyphLine in Lines)
                {
                    ...
                    foreach (var c in GlyphLine)
                    {
                        ...
                        else if (FontLib.get_HasGlyph(c))
                        {
                            ...
                            //The following sentence will be offset by 1 pixel to the right because of an internal error in .Net Framework 2.0.
        ...
        /// <summary>Get an ordinary string of character literals. Only characters that have been mapped to Unicode will be converted. </summary>
    ...
    /// <summary>Font library, mapping of character code points to glyphs. </summary>
    public class FontLib
    {
        ...
        /// <summary>Reloaded. Construct an empty font. </summary>
        public FontLib()
        {
        }

        /// <summary>Reloaded. Construct a font from character code points. If the following characters are repeated with the previous characters, they will not be overwritten. </summary>
        ...
        /// <summary>Reloaded. Construct a font from character code points and glyphs. If the following characters are repeated with the previous characters, they will not be overwritten. </summary>
        /// <remarks>The number of character code points and glyphs must be consistent. </remarks>
       ...
       /// <summary>Get the Unicode-character code point mapping. </summary>
        ...
        /// <summary>Find character code points from custom code points. </summary>
        ...
        /// <summary>Find character code points from characters (UTF-16B). </summary>
        public CharCode LookupWithChar(string c)
        {
            return LookupWithUnicode(Char32.FromString(c));
        }

        /// <summary>Add characters, code points only. If the following characters are repeated with the previous characters, they will not be overwritten. </summary>
        ...
        /// <summary>Add characters, from code points and glyphs. If the following characters are repeated with the previous characters, they will not be overwritten. </summary>
        ...
        /// <summary>Remove characters. </summary>
        ...
        /// <summary>Get or set the specified glyph. </summary>
        ...
        /// <summary>Indicates whether a glyph exists for the specified character code point. </summary>
        public bool get_HasGlyph(CharCode CharCode)
        {
            return Dict.ContainsKey(CharCode) && Dict[CharCode] is not null;
        }

        /// <summary>Get all Unicode characters in the font. </summary>
